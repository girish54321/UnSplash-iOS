...
final class Cache {
    ...
    private init() {
//        NotificationCenter.default.addObserver(self, selector: #selector(Cache.clearSessionCache), name: NSNotification.Name.UIApplication.didReceiveMemoryWarningNotification, object: nil)
    }
